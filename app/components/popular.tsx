...
import { is } from "./../../.next/dev/static/chunks/node_modules_next_dist_shared_lib_82dc2e9d._";
    ...
    useQuery({
      ...
      queryFn: async () => {
        const res = await fetch(
          `${baseUrl}/discover/movie?include_adult=false&include_video=true&api_key=${API_KEY}&language=en-US&page=${page}&sort_by=popularity.desc`
        );
